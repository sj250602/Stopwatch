...
##Buttons
set_property PACKAGE_PIN U18 [get_ports button_s_c]						
	set_property IOSTANDARD LVCMOS33 [get_ports button_s_c]
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets button_s_c]
set_property PACKAGE_PIN T18 [get_ports button_reset]						
	set_property IOSTANDARD LVCMOS33 [get_ports button_reset]
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets button_reset]
set_property PACKAGE_PIN W19 [get_ports button_pause]						
	set_property IOSTANDARD LVCMOS33 [get_ports button_pause]
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets button_pause]
